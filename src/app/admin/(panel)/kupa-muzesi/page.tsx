...
export default async function AdminKupaMuzesiPage() {
  ...
  const { data: trophies } = await supabase
    .from("club_trophies")
    .select("id, name, year, image_url, sort_order, is_active")
    .order("sort_order");
  ...
  return (
    <div>
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-siyah">Tarihi ve Kupa Müzesi</h1>
          <p className="mt-1 text-siyah/70">Kulübümüz sayfasında &quot;Tarihi ve Kupa Müzesi&quot; bölümünde gösterilir. Kupa ismi, yılı, resmi ve açıklaması.</p>
        </div>
